...
from .config import EMAIL_BACKEND, EMAIL_HOST, EMAIL_PORT, EMAIL_USE_TLS, EMAIL_HOST_USER, EMAIL_HOST_PASSWORD, DEFAULT_FROM_EMAIL
...
SECRET_KEY = 'django-insecure-hd3^9jv)u@aja4hf_)9+ky@54!pxj5uk478e7p6w(h4ix@+hli'
